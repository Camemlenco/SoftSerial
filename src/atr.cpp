/**
  ******************************************************************************
  This file is responsible for parsing the ATR (Answer To Reset) received from a
  smart card. It provides functions to decode the ATR and extract relevant parameters
  ******************************************************************************
*/
