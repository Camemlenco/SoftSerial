...
#define SC_CWT_TIMEOUT       ((uint32_t)350)   /* = ~10ms @4MHz + margin */ //**MODIFIED 25->350*
...
/**
  ...
  * @retval None
*/
#define SC_POWER(__NEWSTATE__)  HAL_GPIO_WritePin(SC_CMDVCC_GPIO_PORT, SC_CMDVCC_PIN, (GPIO_PinState) __NEWSTATE__)
...
/**
  ...
  * @retval None
*/
#define SC_3_5V(__NEWSTATE__)  HAL_GPIO_WritePin(SC_3_5V_GPIO_PORT, SC_3_5V_PIN, (GPIO_PinState) __NEWSTATE__)
...
/**
  ...
  * @retval None
*/
#define SC_RESET(__NEWSTATE__)  HAL_GPIO_WritePin(SC_RESET_GPIO_PORT, SC_RESET_PIN, (GPIO_PinState) __NEWSTATE__)
